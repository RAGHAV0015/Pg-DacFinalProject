...
import com.parking.dtos.BookingDTO;
import com.parking.dtos.AreasCheckDTO;
import com.parking.models.Booking;
import com.parking.repos.BookingRepository;

@Service
public class BookingService {

	@Autowired private BookingRepository repo;
	@Autowired private AreasService sservice;
	...
	public List<Booking> allOccupiedBookings(AreasCheckDTO dto){
